...
/**
* @see \App\Http\Controllers\Public\Home\HomeController::home
...
* @route '/realisations'
*/
export const realisations = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: realisations.url(options),
    method: 'get',
})

realisations.definition = {
    methods: ["get","head"],
    url: '/realisations',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/realisations'
*/
realisations.url = (options?: RouteQueryOptions) => {
    return realisations.definition.url + queryParams(options)
}
...
* @route '/realisations'
*/
realisations.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: realisations.url(options),
    method: 'get',
})
...
* @route '/realisations'
*/
realisations.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: realisations.url(options),
    method: 'head',
})
...
* @route '/realisations'
*/
const realisationsForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: realisations.url(options),
    method: 'get',
})
...
* @route '/realisations'
*/
realisationsForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: realisations.url(options),
    method: 'get',
})
...
* @route '/realisations'
*/
realisationsForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: realisations.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
realisations.form = realisationsForm
